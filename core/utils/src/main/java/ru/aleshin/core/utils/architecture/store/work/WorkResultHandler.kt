 ...
 */
interface WorkResultHandler<A : StoreAction, F : StoreEffect, O : BaseOutput> {
    suspend fun WorkResult<A, F, O>.handleWork()
    suspend fun FlowWorkResult<A, F, O>.collectAndHandleWork()
}