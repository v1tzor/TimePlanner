...
object Constants {
    ...
    object App {
        ...
        const val DEEP_LINK_HOST = "timeplanner.com"
        const val EDITOR_DEEP_LINK_PATH = "/openEditor"
        const val HOME_DEEP_LINK_PATH = "/openHome"
        const val OVERVIEW_DEEP_LINK_PATH = "/openOverview"
        const val ANALYTICS_DEEP_LINK_PATH = "/openAnalytics"
        const val GOAL_DETAILS_DEEP_LINK_PATH = "/openGoalDetails"
        const val GOAL_EDITOR_DEEP_LINK_PATH = "/openGoalEditor"
        const val TIME_TASK_ID_QUERY = "timeTaskId"
        const val UNDEFINED_TASK_ID_QUERY = "undefinedTaskId"
        const val GOAL_ID_QUERY = "goalId"
        const val DATE_QUERY = "date"
        const val FROM_QUERY = "from"
        const val TO_QUERY = "to"
    ...
    object Alarm {
        ...
        const val NOTIFICATION_ID = "ALARM_DATA_ID"
        const val TIME_TASK_ID = "ALARM_TIME_TASK_ID"
