...
data class TimePlannerStrings(
    ...
    val ongoingTaskNotifyText: String,
    ...
    val notificationContextFormat: String,
    val notificationTimeRangeFormat: String,
    val notificationBeforeFifteenMinutesText: String,
    val notificationBeforeOneHourText: String,
    val notificationBeforeThreeHoursText: String,
    val notificationBeforeOneDayText: String,
    val notificationBeforeOneWeekText: String,
    val notificationEndsSoonText: String,
    val notificationMarkDoneTitle: String,
...
internal val russianTimePlannerString = TimePlannerStrings(
    ...
    ongoingTaskNotifyText = "Сейчас выполняется",
    ...
    notificationTitleFormat = "%s — %s",
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "через 15 минут",
    notificationBeforeOneHourText = "через 1 час",
    notificationBeforeThreeHoursText = "через 3 часа",
    notificationBeforeOneDayText = "завтра",
    notificationBeforeOneWeekText = "через 1 неделю",
    notificationEndsSoonText = "скоро закончится",
    notificationMarkDoneTitle = "Выполнено",
...
internal val englishTimePlannerString = TimePlannerStrings(
    ...
    ongoingTaskNotifyText = "In progress",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "in 15 minutes",
    notificationBeforeOneHourText = "in 1 hour",
    notificationBeforeThreeHoursText = "in 3 hours",
    notificationBeforeOneDayText = "tomorrow",
    notificationBeforeOneWeekText = "in 1 week",
    notificationEndsSoonText = "ends soon",
    notificationMarkDoneTitle = "Mark as done",
...
internal val germanTimePlannerString = TimePlannerStrings(
    ...
    ongoingTaskNotifyText = "Läuft gerade",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "in 15 Minuten",
    notificationBeforeOneHourText = "in 1 Stunde",
    notificationBeforeThreeHoursText = "in 3 Stunden",
    notificationBeforeOneDayText = "morgen",
    notificationBeforeOneWeekText = "in 1 Woche",
    notificationEndsSoonText = "endet bald",
    notificationMarkDoneTitle = "Erledigt",
...
internal val spanishTimePlannerString = TimePlannerStrings(
    ...
    ongoingTaskNotifyText = "En curso",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "en 15 minutos",
    notificationBeforeOneHourText = "en 1 hora",
    notificationBeforeThreeHoursText = "en 3 horas",
    notificationBeforeOneDayText = "mañana",
    notificationBeforeOneWeekText = "en 1 semana",
    notificationEndsSoonText = "termina pronto",
    notificationMarkDoneTitle = "Marcar como hecho",
...
internal val persianTimePlannerString = TimePlannerStrings(
    ...
    ongoingTaskNotifyText = "در حال انجام",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "تا ۱۵ دقیقه دیگر",
    notificationBeforeOneHourText = "تا ۱ ساعت دیگر",
    notificationBeforeThreeHoursText = "تا ۳ ساعت دیگر",
    notificationBeforeOneDayText = "فردا",
    notificationBeforeOneWeekText = "تا ۱ هفته دیگر",
    notificationEndsSoonText = "به‌زودی تمام می‌شود",
    notificationMarkDoneTitle = "انجام شد",
...
internal val frenchTimePlannerString = TimePlannerStrings(
    ...
    ongoingTaskNotifyText = "En cours",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "dans 15 minutes",
    notificationBeforeOneHourText = "dans 1 heure",
    notificationBeforeThreeHoursText = "dans 3 heures",
    notificationBeforeOneDayText = "demain",
    notificationBeforeOneWeekText = "dans 1 semaine",
    notificationEndsSoonText = "se termine bientôt",
    notificationMarkDoneTitle = "Marquer comme fait",
...
internal val brazilianPortugueseTimePlannerString = TimePlannerStrings(
    ...
    ongoingTaskNotifyText = "Em andamento",
    timeTaskChannelName = "Eventos",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "em 15 minutos",
    notificationBeforeOneHourText = "em 1 hora",
    notificationBeforeThreeHoursText = "em 3 horas",
    notificationBeforeOneDayText = "amanhã",
    notificationBeforeOneWeekText = "em 1 semana",
    notificationEndsSoonText = "termina em breve",
    notificationMarkDoneTitle = "Marcar como feito",
...
internal val turkishTimePlannerString = TimePlannerStrings(
    ...
    ongoingTaskNotifyText = "Devam ediyor",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "15 dakika içinde",
    notificationBeforeOneHourText = "1 saat içinde",
    notificationBeforeThreeHoursText = "3 saat içinde",
    notificationBeforeOneDayText = "yarın",
    notificationBeforeOneWeekText = "1 hafta içinde",
    notificationEndsSoonText = "yakında bitiyor",
    notificationMarkDoneTitle = "Tamamlandı",
    priorityStandard = "Normal",
    priorityMedium = "Orta",
    priorityMax = "Azami",
...
internal val vietnameseTimePlannerString = TimePlannerStrings(
    appName = "Time Planner",
    authorTitle = "Được tạo bởi Aleshin Stanislav",
    startTaskNotifyText = "Khởi đầu của sự kiện",
    ongoingTaskNotifyText = "Đang thực hiện",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "trong 15 phút",
    notificationBeforeOneHourText = "trong 1 giờ",
    notificationBeforeThreeHoursText = "trong 3 giờ",
    notificationBeforeOneDayText = "ngày mai",
    notificationBeforeOneWeekText = "trong 1 tuần",
    notificationEndsSoonText = "sắp kết thúc",
    notificationMarkDoneTitle = "Đánh dấu đã xong",
...
internal val polishTimePlannerString = TimePlannerStrings(
    appName = "Time Planner",
    authorTitle = "Stworzone przez Aleshin Stanislav",
    startTaskNotifyText = "Początek zdarzenia",
    ongoingTaskNotifyText = "W trakcie",
    ...
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "za 15 minut",
    notificationBeforeOneHourText = "za 1 godzinę",
    notificationBeforeThreeHoursText = "za 3 godziny",
    notificationBeforeOneDayText = "jutro",
    notificationBeforeOneWeekText = "za 1 tydzień",
    notificationEndsSoonText = "wkrótce się kończy",
    notificationMarkDoneTitle = "Oznacz jako wykonane",
...
internal val italianTimePlannerString = TimePlannerStrings(
    appName = "Time Planner",
    authorTitle = "Creata da Aleshin Stanislav",
    startTaskNotifyText = "L'inizio dell'evento",
    ongoingTaskNotifyText = "In corso",
    timeTaskChannelName = "Eventi",
    categoryWorkTitle = "Lavoro",
    categoryRestTitle = "Riposo",
    categorySportTitle = "Sport",
    categorySleepTitle = "Sonno",
    categoryCultureTitle = "Cultura",
    categoryChoresTitle = "Faccende",
    categoryTransportTitle = "Trasporti",
    categoryStudyTitle = "Studio",
    categoryEatTitle = "Alimentazione",
    categoryEntertainmentsTitle = "Intrattenimento",
    categoryHygieneTitle = "Cura Personale",
    categoryHealthTitle = "Salute",
    categoryShoppingTitle = "Shopping",
    categoryOtherTitle = "Altro",
    minutesSymbol = "m",
    hoursSymbol = "h",
    separator = ":",
    cancelTitle = "Cancella",
    confirmTitle = "Seleziona",
    okConfirmTitle = "OK",
    categoryEmptyTitle = "Vuoto",
    expandedViewToggleTitle = "Mostra di più",
    compactViewToggleTitle = "Mostra di meno",
    warningDialogTitle = "Attenzione!",
    warningDeleteConfirmTitle = "Elimina",
    hoursTitle = "Ore",
    minutesTitle = "Minuti",
    dayTitle = "d.",
    homeTabTitle = "Home",
    analyticsTabTitle = "Statistiche",
    settingsTabTitle = "Impostazioni",
    mainDrawerTitle = "Giornata",
    overviewDrawerTitle = "Riepilogo",
    drawerMainSection = "Pianificazione",
    templateDrawerTitle = "Template",
    categoriesDrawerTitle = "Categorie",
    splitFormat = "%s | %s",
    amFormatTitle = "AM",
    pmFormatTitle = "PM",
    repeatTimeDayInMonthTitle = "Ogni Mese",
    repeatTimeDayInWeekTitle = "Ogni Settimana",
    repeatTimeWeekDayInMonthTitle = "Ogni settimana del mese",
    repeatTimeDayInYearTitle = "Ogni Anno",
    ...
    januaryTitle = "Gennaio",
    februaryTitle = "Febbraio",
    marchTitle = "Marzo",
    aprilTitle = "Aprile",
    mayTitle = "Maggio",
    juneTitle = "Giugno",
    julyTitle = "Luglio",
    augustTitle = "Agosto",
    septemberTitle = "Settembre",
    octoberTitle = "Ottobre",
    novemberTitle = "Novembre",
    decemberTitle = "Dicembre",
    beforeTaskNotifyText = "Promemoria per un evento in arrivo",
    afterTaskNotifyText = "Fine dell'evento",
    notificationTitleFormat = "%s — %s",
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "tra 15 minuti",
    notificationBeforeOneHourText = "tra 1 ora",
    notificationBeforeThreeHoursText = "tra 3 ore",
    notificationBeforeOneDayText = "domani",
    notificationBeforeOneWeekText = "tra 1 settimana",
    notificationEndsSoonText = "termina presto",
    notificationMarkDoneTitle = "Segna come fatto",
    priorityStandard = "Normale",
    priorityMedium = "Media",
    priorityMax = "Massima",
    emptyScheduleTitle = "Niente di pianificato al momento",
)


internal val chineseTimePlannerString = TimePlannerStrings(
    appName = "Time Planner",
    authorTitle = "由 Aleshin Stanislav 创建",
    startTaskNotifyText = "事件开始",
    ongoingTaskNotifyText = "进行中",
    timeTaskChannelName = "事件",
    categoryWorkTitle = "工作",
    categoryRestTitle = "休息",
    categorySportTitle = "运动",
    categorySleepTitle = "睡眠",
    categoryCultureTitle = "文化",
    categoryChoresTitle = "家务",
    categoryTransportTitle = "交通",
    categoryStudyTitle = "学习",
    categoryEatTitle = "用餐",
    categoryEntertainmentsTitle = "娱乐",
    categoryHygieneTitle = "个人护理",
    categoryHealthTitle = "健康",
    categoryShoppingTitle = "购物",
    categoryOtherTitle = "其他",
    minutesSymbol = "分",
    hoursSymbol = "时",
    separator = ":",
    cancelTitle = "取消",
    confirmTitle = "选择",
    okConfirmTitle = "确定",
    categoryEmptyTitle = "无",
    expandedViewToggleTitle = "展开视图",
    compactViewToggleTitle = "紧凑视图",
    warningDialogTitle = "警告！",
    warningDeleteConfirmTitle = "删除",
    hoursTitle = "小时",
    minutesTitle = "分钟",
    dayTitle = "天",
    homeTabTitle = "首页",
    analyticsTabTitle = "统计",
    settingsTabTitle = "设置",
    mainDrawerTitle = "主页",
    overviewDrawerTitle = "概览",
    drawerMainSection = "计划",
    templateDrawerTitle = "模板",
    categoriesDrawerTitle = "分类",
    splitFormat = "%s | %s",
    amFormatTitle = "上午",
    pmFormatTitle = "下午",
    repeatTimeDayInMonthTitle = "每月",
    repeatTimeDayInWeekTitle = "每周",
    repeatTimeWeekDayInMonthTitle = "每月指定周",
    repeatTimeDayInYearTitle = "每年",
    sundayTitle = "星期日",
    mondayTitle = "星期一",
    tuesdayTitle = "星期二",
    wednesdayTitle = "星期三",
    ...
    novemberTitle = "十一月",
    decemberTitle = "十二月",
    beforeTaskNotifyText = "即将开始的事件提醒",
    afterTaskNotifyText = "事件结束",
    notificationTitleFormat = "%s — %s",
    notificationContextFormat = "%s · %s",
    notificationTimeRangeFormat = "%s–%s",
    notificationBeforeFifteenMinutesText = "15 分钟后",
    notificationBeforeOneHourText = "1 小时后",
    notificationBeforeThreeHoursText = "3 小时后",
    notificationBeforeOneDayText = "明天",
    notificationBeforeOneWeekText = "1 周后",
    notificationEndsSoonText = "即将结束",
    notificationMarkDoneTitle = "标记为已完成",
    priorityStandard = "普通",
    priorityMedium = "中等",
    priorityMax = "最高",
    emptyScheduleTitle = "暂无计划",
)
...
fun fetchCoreStrings(language: TimePlannerLanguage) = when (language) {
    ...
    TimePlannerLanguage.PL -> polishTimePlannerString
    TimePlannerLanguage.IT -> italianTimePlannerString
    TimePlannerLanguage.ZH -> chineseTimePlannerString
}
