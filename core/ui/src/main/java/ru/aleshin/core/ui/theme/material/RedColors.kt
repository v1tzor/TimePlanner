...
val red_theme_dark_background = Color(0xFF131318)
...
val red_theme_dark_outlineVariant = Color(0xFF464141)
val red_theme_dark_scrim = Color(0xFF000000)
val red_theme_dark_surface = Color(0xFF1B1718)
val red_theme_dark_onSurface = Color(0xFFE0D9DA)
val red_theme_dark_surfaceVariant = Color(0xFF504548)
val red_theme_dark_onSurfaceVariant = Color(0xFFCEC1C3)
