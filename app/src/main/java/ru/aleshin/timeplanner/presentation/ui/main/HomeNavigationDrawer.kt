...
import ru.aleshin.timeplanner.core.ui.views.DrawerItems
import ru.aleshin.timeplanner.core.ui.views.DrawerLogoSection
...
fun HomeNavigationDrawer(
    ...
    val selectedItem by drawerManager.selectedItem
        ...
        drawerContent = {
            ModalDrawerSheet {
                ...
                DrawerItems(
                    ...
                    onItemSelected = { item ->
                        scope.launch {
                            drawerManager.sendEvent(item.index)
                            drawerState.close()
                        }
                    },
                )
