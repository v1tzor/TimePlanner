...
interface NotificationContentMapper {
    ...
    class Base @Inject constructor() : NotificationContentMapper {

        override fun mapTimeTask(
            timeTask: TimeTask,
            notificationType: TaskNotificationType,
            strings: TimePlannerStrings,
        ): NotificationContent {
        ...
        override fun mapTemplate(
            ...
            val details = when (timeType) {
                NotificationTimeType.START_TASK -> strings.notificationTimeRangeFormat.format(
                    timeFormat.format(startTime),
                    timeFormat.format(endTime),
                )
                NotificationTimeType.BEFORE_TASK -> strings.beforeTaskNotifyText
                NotificationTimeType.AFTER_TASK -> strings.notificationEndsSoonText
            }
            return NotificationContent(
                title = strings.notificationDetailsFormat.format(categoryTitle, details),
                text = "",
