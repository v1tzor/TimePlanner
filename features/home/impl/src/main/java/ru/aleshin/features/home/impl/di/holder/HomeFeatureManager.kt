 ...
 */
public object HomeFeatureManager : BaseFeatureManager<HomeFeatureApi, HomeFeatureDependencies> {

    private var component: HomeComponent? = null

    override fun createOrGetFeature(dependencies: HomeFeatureDependencies): HomeFeatureApi {
        return component ?: HomeComponent.create(dependencies).apply {
            this@HomeFeatureManager.component = this
        }
    }
