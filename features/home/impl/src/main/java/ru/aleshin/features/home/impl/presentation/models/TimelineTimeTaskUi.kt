...
@Immutable
@Serializable
internal data class TimelineTimeTaskUi(
    val timeTask: TimeTaskUi,
    val executionStatus: TimeTaskStatus,
    val visibleTimeRange: TimeRange,
    @Serializable(DateSerializer::class) val minimumStartTime: Date,
    @Serializable(DateSerializer::class) val maximumEndTime: Date,
    val canMove: Boolean,
    val canResizeStart: Boolean,
    val canResizeEnd: Boolean,
)
