...
internal fun UndefinedTasksBatchEditorHeader(
    ...
    Column(
        ...
        Text(
            text = HomeThemeRes.strings.sharedTasksDialogTitle,
            color = MaterialTheme.colorScheme.onSurface,
            style = MaterialTheme.typography.headlineSmall,
        )
        Text(
            text = HomeThemeRes.strings.sharedTasksDialogDesc,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
            style = MaterialTheme.typography.bodyMedium,
        )
        Text(
            text = HomeThemeRes.strings.sharedTasksCountFormat.format(tasksCount),
