 ...
 */
internal interface CategoriesEffectCommunicator : EffectCommunicator<CategoriesEffect> {

    class Base @Inject constructor() : CategoriesEffectCommunicator,
        EffectCommunicator.Abstract<CategoriesEffect>()
}
