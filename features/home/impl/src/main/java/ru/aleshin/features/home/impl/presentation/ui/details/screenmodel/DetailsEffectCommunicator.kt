 ...
 */
internal interface DetailsEffectCommunicator : EffectCommunicator<DetailsEffect> {

    class Base @Inject constructor() : DetailsEffectCommunicator,
        EffectCommunicator.Abstract<DetailsEffect>()
}
