 ...
 */
internal interface TemplatesEffectCommunicator : EffectCommunicator<TemplatesEffect> {

    class Base @Inject constructor() : TemplatesEffectCommunicator,
        EffectCommunicator.Abstract<TemplatesEffect>()
}
