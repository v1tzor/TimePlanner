...
internal fun MainCategoryItem(
    ...
    if (isWarningDeleteDialogOpen) {
        WarningDeleteDialog(
            text = EditorThemeRes.strings.warningDeleteCategoryText,
    ...
    Surface(
        ...
        Box(contentAlignment = Alignment.Center) {
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                Text(
                    text = EditorThemeRes.strings.addCategoryTitle,
...
internal fun MainCategoriesOptionMenu(
    ...
    DropdownMenu(
        ...
        DropdownMenuItem(
            ...
            text = {
                Text(
                    text = EditorThemeRes.strings.updateCategoryTitle,
                    color = MaterialTheme.colorScheme.onSurface,
            ...
            leadingIcon = {
                Icon(
                    ...
                    contentDescription = EditorThemeRes.strings.updateCategoryTitle,
                    tint = MaterialTheme.colorScheme.onSurface,
                )
            },
        )
        ...
        DropdownMenuItem(
            ...
            text = {
                Text(
                    text = EditorThemeRes.strings.deleteCategoryTitle,
            ...
            leadingIcon = {
                Icon(
                    ...
                    contentDescription = EditorThemeRes.strings.deleteCategoryTitle,
