...
internal val englishEditorString = EditorStrings(
    ...
    saveTemplateWarningTitle = "Apply changes to current template?",
    saveTemplateWarningConfirm = "Yes",
    saveTemplateWarningUnsave = "No",
    categoriesManageWarningTitle = "Proceed to category management? " +
        "Changes to the current parameters will not be saved.",
