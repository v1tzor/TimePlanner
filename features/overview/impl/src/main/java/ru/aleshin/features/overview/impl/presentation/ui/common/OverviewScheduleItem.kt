        ...
        Row(
                ...
                Column {
                    Text(
                        text = when (model.dateStatus) {
                            DailyScheduleStatus.REALIZED -> OverviewThemeRes.strings.realizedScheduleTitle
                            DailyScheduleStatus.ACCOMPLISHMENT -> OverviewThemeRes.strings.accomplishmentScheduleTitle
                            DailyScheduleStatus.PLANNED -> OverviewThemeRes.strings.plannedScheduleTitle
                        },
                        color = MaterialTheme.colorScheme.primary,
                        maxLines = 1,
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ShortInfoView(
                    ...
                    icon = painterResource(id = OverviewThemeRes.icons.unexecutedTask),
                )
                ShortInfoView(
                    modifier = Modifier.weight(1f),
                    enabled = model.dateStatus != DailyScheduleStatus.PLANNED,
                    text = model.completedTask.toString(),
                    icon = painterResource(id = OverviewThemeRes.icons.completedTask),
                )
                ShortInfoView(
                    modifier = Modifier.weight(1f),
