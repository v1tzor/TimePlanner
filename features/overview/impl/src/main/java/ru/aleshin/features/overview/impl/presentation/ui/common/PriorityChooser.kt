...
internal fun PriorityChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = OverviewThemeRes.icons.priority),
            contentDescription = OverviewThemeRes.strings.priorityLabel,
            tint = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        Text(
            modifier = Modifier.weight(1f),
            text = OverviewThemeRes.strings.priorityLabel,
