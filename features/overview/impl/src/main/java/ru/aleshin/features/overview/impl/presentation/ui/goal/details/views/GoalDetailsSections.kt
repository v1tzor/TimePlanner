...
internal fun GoalSummarySection(
    ...
    val statusTitle = when (progress.status) {
        GoalProgressStatus.IN_PROGRESS -> strings.inProgressTitle
        GoalProgressStatus.ACHIEVED -> strings.achievedTitle
        GoalProgressStatus.EXCEEDED -> strings.exceededTitle
        GoalProgressStatus.EXPIRED -> strings.expiredTitle
        GoalProgressStatus.UNAVAILABLE -> strings.scopeUnavailableTitle
    }
    Surface(
...
internal fun GoalTasksEmptyCard(
    ...
    Surface(
        ...
        Row(
            ...
            Text(
                modifier = Modifier.weight(1f),
                text = OverviewThemeRes.goalStrings.emptyGoalTasksTitle,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
                style = MaterialTheme.typography.bodyMedium,
            )
        }
