...
internal interface UndefinedTasksInteractor {
    ...
    suspend fun addOrUpdateUndefinedTasks(tasks: List<UndefinedTask>): UnitDomainResult<OverviewFailures>
    suspend fun fetchAllUndefinedTasks(): FlowDomainResult<OverviewFailures, List<UndefinedTask>>
    suspend fun deleteUndefinedTaskById(taskId: Long): UnitDomainResult<OverviewFailures>
