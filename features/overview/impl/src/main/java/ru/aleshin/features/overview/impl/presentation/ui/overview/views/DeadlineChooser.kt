...
internal fun DeadlineChooser(
    ...
    Row(
        ...
        Text(
            ...
            text = OverviewThemeRes.strings.deadlineLabel,
        ...
        Row(
            ...
            if (deadline != null) {
                ...
                SuggestionChip(
                    label = { Text(text = OverviewThemeRes.strings.specifyDeadlineTitle) },
                    onClick = { openDateChooserDialog = true },
                )
            }
        }
            ...
            DatePicker(
                ...
                title = {
                    Text(
                        ...
                        text = OverviewThemeRes.strings.dateDialogPickerTitle,
                    )
                },
                headline = {
                    Text(
                        modifier = Modifier.padding(start = 24.dp),
                        text = OverviewThemeRes.strings.dateDialogPickerHeadline,
                    )
                },
            )
        }
