...
import ru.aleshin.features.overview.impl.presentation.ui.common.PriorityChooser
            ...
            Column {
                ...
                DialogButtons(
                    ...
                    confirmTitle = when (model != null) {
                        ...
                        false -> OverviewThemeRes.strings.dialogCreateTitle
                    },
                    onConfirmClick = {
                        if (isEnabled) {
...
internal fun UndefinedTaskEditorDialogHeader(
    ...
    Column(
        ...
        Text(
            text = OverviewThemeRes.strings.addTaskTitle,
...
internal fun NoteCompactTextField(
    ...
    Row(
        ...
        OutlinedTextField(
            ...
            label = { Text(text = OverviewThemeRes.strings.noteTitle) },
