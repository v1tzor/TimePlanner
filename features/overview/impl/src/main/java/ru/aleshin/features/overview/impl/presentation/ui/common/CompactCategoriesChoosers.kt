 ...
 */
package ru.aleshin.features.overview.impl.presentation.ui.common
...
internal fun CompactCategoryChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = OverviewThemeRes.icons.category),
            contentDescription = OverviewThemeRes.strings.mainCategoryLabel,
        ...
        OutlinedTextField(
            ...
            onValueChange = {},
            readOnly = true,
            label = { Text(text = OverviewThemeRes.strings.mainCategoryLabel) },
...
internal fun CompactSubCategoryChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = OverviewThemeRes.icons.subCategory),
            contentDescription = OverviewThemeRes.strings.subCategoryLabel,
            tint = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        OutlinedTextField(
            modifier = Modifier.fillMaxWidth(),
            value = selectedSubCategory?.name ?: OverviewThemeRes.strings.subCategoryEmptyTitle,
            onValueChange = {},
            readOnly = true,
            label = { Text(text = OverviewThemeRes.strings.subCategoryLabel) },
