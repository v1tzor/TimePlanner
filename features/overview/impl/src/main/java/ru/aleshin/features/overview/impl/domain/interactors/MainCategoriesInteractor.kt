...
internal interface MainCategoriesInteractor {
    ...
    suspend fun fetchCategories(): FlowDomainResult<OverviewFailures, List<MainCategoryDetails>>
    suspend fun addOrUpdateMainCategory(mainCategory: MainCategory): DomainResult<OverviewFailures, Long>
    suspend fun deleteMainCategoryById(mainCategoryId: Long): UnitDomainResult<OverviewFailures>
    suspend fun restoreDefaultCategories(): UnitDomainResult<OverviewFailures>
