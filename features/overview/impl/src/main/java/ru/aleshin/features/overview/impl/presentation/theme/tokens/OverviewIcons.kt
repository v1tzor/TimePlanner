...
internal data class OverviewIcons(
    ...
    val subCategory: Int,
    val priority: Int,
    val priorityStandard: Int,
    val priorityMedium: Int,
    val priorityMax: Int,
    val duration: Int,
    val notes: Int,
    val schedule: Int,
...
internal val baseOverviewIcons = OverviewIcons(
    ...
    priorityStandard = R.drawable.ic_priority_standard,
    priorityMedium = R.drawable.ic_priority_medium,
    priorityMax = R.drawable.ic_priority_max,
