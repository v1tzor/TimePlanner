...
internal interface MainCategoriesInteractor {
    ...
    suspend fun fetchCategories(): FlowDomainResult<TemplatesFailures, List<MainCategoryDetails>>
    suspend fun addOrUpdateMainCategory(mainCategory: MainCategory): DomainResult<TemplatesFailures, Long>
    suspend fun deleteMainCategoryById(mainCategoryId: Long): UnitDomainResult<TemplatesFailures>
    suspend fun restoreDefaultCategories(): UnitDomainResult<TemplatesFailures>
