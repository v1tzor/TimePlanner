...
internal fun PriorityChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = TemplatesThemeRes.icons.priority),
            contentDescription = TemplatesThemeRes.strings.priorityLabel,
            tint = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        Text(
            modifier = Modifier.weight(1f),
            text = TemplatesThemeRes.strings.priorityLabel,
