 ...
 */
package ru.aleshin.features.templates.impl.presentation.ui.common
...
internal fun CompactCategoryChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = TemplatesThemeRes.icons.category),
            contentDescription = TemplatesThemeRes.strings.mainCategoryLabel,
        ...
        OutlinedTextField(
            ...
            onValueChange = {},
            readOnly = true,
            label = { Text(text = TemplatesThemeRes.strings.mainCategoryLabel) },
...
internal fun CompactSubCategoryChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = TemplatesThemeRes.icons.subCategory),
            contentDescription = TemplatesThemeRes.strings.subCategoryLabel,
            tint = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        OutlinedTextField(
            modifier = Modifier.fillMaxWidth(),
            value = selectedSubCategory?.name ?: TemplatesThemeRes.strings.subCategoryEmptyTitle,
            onValueChange = {},
            readOnly = true,
            label = { Text(text = TemplatesThemeRes.strings.subCategoryLabel) },
