...
import ru.aleshin.features.templates.impl.presentation.ui.common.CompactCategoryChooser
import ru.aleshin.features.templates.impl.presentation.ui.common.CompactSubCategoryChooser
import ru.aleshin.features.templates.impl.presentation.ui.common.PriorityChooser
            ...
            Column {
                ...
                DialogButtons(
                    ...
                    confirmTitle = when (model != null) {
                        ...
                        false -> TemplatesThemeRes.strings.dialogCreateTitle
                    },
                    onConfirmClick = {
...
internal fun TemplateEditorStartTimeChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = TemplatesThemeRes.icons.startTime),
            contentDescription = TemplatesThemeRes.strings.startTimeLabel,
        ...
        Row(
            ...
            OutlinedTextField(
                ...
                label = { Text(text = TemplatesThemeRes.strings.startTimeLabel) },
            )
            Text(
                text = ":",
...
internal fun TemplateEditorEndTimeChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = TemplatesThemeRes.icons.endTime),
            contentDescription = TemplatesThemeRes.strings.endTimeLabel,
            tint = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        Row(
            modifier = Modifier.weight(1f),
            ...
            OutlinedTextField(
                ...
                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                shape = MaterialTheme.shapes.large,
                label = { Text(text = TemplatesThemeRes.strings.endTimeLabel) },
            )
            Text(
                text = ":",
                style = MaterialTheme.typography.titleLarge,
...
internal fun TemplateEditorNotificationChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = TemplatesThemeRes.icons.notification),
            contentDescription = TemplatesThemeRes.strings.notificationLabel,
            tint = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        Row(
            verticalAlignment = Alignment.CenterVertically,
            ...
            Text(
                modifier = Modifier.weight(1f),
                text = TemplatesThemeRes.strings.notificationLabel,
...
internal fun TemplateEditorStatisticsChooser(
    ...
    Row(
        ...
        Icon(
            painter = painterResource(id = TemplatesThemeRes.icons.info),
            contentDescription = TemplatesThemeRes.strings.statisticsLabel,
            tint = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        Row(
            verticalAlignment = Alignment.CenterVertically,
            ...
            Text(
                modifier = Modifier.weight(1f),
                text = TemplatesThemeRes.strings.statisticsLabel,
                style = MaterialTheme.typography.titleMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
...
internal fun TemplateEditorDialogHeader(
    ...
    Column(
        ...
        Text(
            text = TemplatesThemeRes.strings.templateEditorHeader,
            color = MaterialTheme.colorScheme.onSurface,
