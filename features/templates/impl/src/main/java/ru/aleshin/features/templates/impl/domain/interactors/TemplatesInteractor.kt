...
internal interface TemplatesInteractor {
    ...
    suspend fun fetchTemplates(sortedType: TemplatesSortedType): FlowDomainResult<TemplatesFailures, List<Template>>
    suspend fun checkIsTemplate(timeTask: TimeTask): DomainResult<TemplatesFailures, Template?>
