...
internal data class AnalyticsStrings(
    ...
    val hourlyWorkLoadAnalyticsTitle: String,
    val hourlyWorkLoadPeakFormat: String,
...
internal val russianAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Загруженность по часам",
    hourlyWorkLoadPeakFormat = "Пик: %s, %s",
...
internal val englishAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Workload by hour",
    hourlyWorkLoadPeakFormat = "Peak: %s, %s",
...
internal val persianAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "حجم کار بر اساس ساعت",
    hourlyWorkLoadPeakFormat = "اوج: %s، %s",
...
internal val germanAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Auslastung nach Uhrzeit",
    hourlyWorkLoadPeakFormat = "Spitze: %s, %s",
...
internal val spanishAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Carga por hora",
    hourlyWorkLoadPeakFormat = "Pico: %s, %s",
...
internal val frenchAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Charge par heure",
    hourlyWorkLoadPeakFormat = "Pic: %s, %s",
...
internal val turkishAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Saatlik iş yükü",
    hourlyWorkLoadPeakFormat = "Zirve: %s, %s",
...
internal val vietnameseAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Khối lượng theo giờ",
    hourlyWorkLoadPeakFormat = "Cao nhất: %s, %s",
...
internal val polishAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Obciążenie według godzin",
    hourlyWorkLoadPeakFormat = "Szczyt: %s, %s",
...
internal val italianAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "Carico per ora",
    hourlyWorkLoadPeakFormat = "Picco: %s, %s",
...
internal val chineseAnalyticsString = AnalyticsStrings(
    ...
    hourlyWorkLoadAnalyticsTitle = "按小时统计负荷",
    hourlyWorkLoadPeakFormat = "高峰：%s，%s",
