...
internal fun AnalyticsDurationSection(
    ...
    AnalyticsSection(
        modifier = modifier,
        title = AnalyticsThemeRes.strings.durationStructureTitle,
    ) {
        AnalyticsDurationContent(durationsAnalytics = durationsAnalytics)
    }
}

@Composable
internal fun AnalyticsExpandedDurationSection(
    modifier: Modifier = Modifier,
    durationsAnalytics: AnalyticsDurationDistributionUi,
) {
...
@Composable
private fun AnalyticsDurationContent(
    durationsAnalytics: AnalyticsDurationDistributionUi,
) {
