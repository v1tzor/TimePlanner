...
@Composable
internal fun AnalyticsExpandedSection(
    modifier: Modifier = Modifier,
    title: String,
    contentPadding: PaddingValues = PaddingValues(16.dp),
    verticalSpacing: Dp = 16.dp,
...
internal fun AnalyticsComparison.formatAnalyticsComparison(
    formatter: AnalyticsValueFormatter,
    locale: Locale,
    strings: AnalyticsStrings,
) = when (state) {
    AnalyticsComparisonState.VALUE -> formatter.formatSignedPercent(changePercent ?: 0.0, locale)
    AnalyticsComparisonState.UNCHANGED -> strings.comparisonUnchanged
    AnalyticsComparisonState.PREVIOUS_ZERO -> strings.comparisonPreviousZero
