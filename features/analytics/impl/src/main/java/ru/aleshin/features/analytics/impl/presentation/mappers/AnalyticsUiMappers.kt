...
import ru.aleshin.features.analytics.impl.presentation.models.analytics.HourlyWorkLoadAnalyticUi
import ru.aleshin.features.analytics.impl.presentation.models.analytics.PlanningAnalyticUi
import ru.aleshin.features.analytics.impl.presentation.models.analytics.ScheduleAnalyticsUi
import ru.aleshin.features.analytics.impl.presentation.models.analytics.SubCategoryAnalyticUi
...
internal fun ScheduleAnalytics.mapToUi() = ScheduleAnalyticsUi(
    ...
    hourlyWorkLoadAnalytics = hourlyWorkLoadAnalytics.map { it.mapToUi() },
...
internal fun HourlyWorkLoadAnalytic.mapToUi() = HourlyWorkLoadAnalyticUi(
    fromHour = fromHour,
    toHour = toHour,
    duration = duration,
)
