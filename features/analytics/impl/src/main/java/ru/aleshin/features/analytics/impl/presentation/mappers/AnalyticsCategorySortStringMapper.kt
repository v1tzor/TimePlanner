 ...
 */
internal fun AnalyticsCategorySort.toTitle(strings: AnalyticsStrings) = when (this) {
    AnalyticsCategorySort.BY_TIME -> strings.byTime
    AnalyticsCategorySort.BY_TASKS -> strings.byTasks
}
