...
import ru.aleshin.features.analytics.impl.di.holder.AnalyticsFeatureManager

/**
 * @author Stanislav Aleshin on 13.09.2025.
 */
public class DefaultAnalyticsFeatureStarter(
    private val dependenciesFactory: () -> AnalyticsFeatureDependencies,
) : AnalyticsFeatureStarter {

    override fun createOrGetFeature(): AnalyticsFeatureApi {
        return AnalyticsFeatureManager.createOrGetFeature(dependenciesFactory())
    }
}