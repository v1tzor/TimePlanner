 ...
 */
internal interface SettingsEffectCommunicator : EffectCommunicator<SettingsEffect> {

    class Base @Inject constructor() : SettingsEffectCommunicator,
        EffectCommunicator.Abstract<SettingsEffect>()
}
